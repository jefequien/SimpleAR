...
class ModelArguments:
    ...
    pos_type: Optional[str] = field(default="1d")
    ...
    share_vt_as_vq: str = field(default=False)
    vq_model: Optional[str] = field(default=None)
    vq_model_ckpt: Optional[str] = field(default=None)

    rand_init: Optional[bool] = field(default=False)
...
class DataArguments:
    ...
    gen_resolution: Optional[int] = field(default=384)
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        for attempt_idx in range(num_base_retries):
            try:
                ...
                # no need to sleep
                print(f"LLava... [Try other #{attempt_idx}] Failed to fetch sample {next_index}. Exception:", e)
                pass
